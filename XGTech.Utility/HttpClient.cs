...
namespace XGTech.Utility
{
    public class HttpClient
    {
        ...
        public HttpClient(string url, Dictionary<string, string> data)
            : this(url, null, data)
        {
        }
        ...
        /// <param name="data"></param>
        public HttpClient(string url, HttpClientContext context, Dictionary<string, string> data)
            : this(url, context, false, data)
        {
        }
        ...
        /// <param name="data"></param>
        public HttpClient(string url, HttpClientContext context, bool keepContext, Dictionary<string, string> data)
        {
            this.url = url;
        ...
        private HttpWebRequest CreateRequest()
        {
            ...
            if (postingData != null && (postingData.Count > 0 || files.Count > 0))
                verb = HttpVerb.POST;
        ...
        {
            byte[] data = GetBytes();
            string encodingName = GetEncodingFromHeaders() ?? GetEncodingFromBody(data);
