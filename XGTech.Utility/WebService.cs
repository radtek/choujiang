...
namespace XGTech.Utility
{
    public class WebService
    {
        ...
        //ht.Add("str", "test");
        //ht.Add("b", "true");
        //XmlDocument xx = WebService.QuerySoapWebService("http://222.66.39.201:22220/webservice/Service.asmx/getTrackByBillCodes", "HelloWorld", ht);
        #endregion
        ...
        private static Hashtable _xmlNamespaces = new Hashtable();//缓存xmlNamespace，避免重复调用
    }
}
