...
function getLodop(oOBJECT,oEMBED){
    ...
    var strCLodopInstall = "<br><font color='#FF00FF'>CLodop云打印服务(localhost本地)未安装启动!点击这里<a href='/Scripts/lodop/CLodop_Setup_for_Win32NT.exe' target='_self'>执行安装</a>,安装后请刷新页面。</font>";
    var strCLodopUpdate = "<br><font color='#FF00FF'>CLodop云打印服务需升级!点击这里<a href='/Scripts/lodop/CLodop_Setup_for_Win32NT.exe' target='_self'>执行升级</a>,升级后请刷新页面。</font>";
    var LODOP;
    try{
        ...
        //暂时使用，需要公司购买正版
        LODOP.SET_LICENSES("苏州埃捷思特软件技术有限公司", "2995EE963289CE56139E0A630BA7FE43", "", "");
        //===========================================================
        return LODOP;
